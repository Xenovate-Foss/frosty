...
const COLORS = {
    black: '#121212',
    red: '#e53e3e', // Using a standard Tailwind red
    blue: '#3182ce', // Using a standard Tailwind blue
    textLight: '#f7fafc',
    textDim: '#cbd5e0',
};
...
export default () => {
    ...
    const [showSearch, setShowSearch] = useState(false); // Fixed: usestate -> useState
    ...
    return (
        <>
            ...
            <div
                ...
                style={{
                    marginLeft: !isMobile && expanded ? '250px' : !isMobile ? '64px' : '0',
                }}
            >
